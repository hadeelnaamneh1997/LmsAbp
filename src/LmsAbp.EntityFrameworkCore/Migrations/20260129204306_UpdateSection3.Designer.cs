...
{
    [DbContext(typeof(LmsAbpDbContext))]
    [Migration("20260129204306_UpdateSection3")]
    partial class UpdateSection3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LmsAbp.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("LmsAbp.Sections.Section", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LmsAbp.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LmsAbp.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LmsAbp.Sections.Section", b =>
                {
                    b.HasOne("LmsAbp.Courses.Course", "Course")
                        .WithMany("Sections")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LmsAbp.Teachers.Teacher", "Teacher")
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("SectionStudent", b =>
                {
                    b.HasOne("LmsAbp.Sections.Section", null)
                        .WithMany()
                        .HasForeignKey("SectionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LmsAbp.Students.Student", null)
                        .WithMany()
